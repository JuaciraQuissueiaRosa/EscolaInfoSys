...
namespace EscolaInfoSys.Migrations
{
    ...
    [Migration("20250709130212_AddTotalLessonsToSubject")]
    partial class AddTotalLessonsToSubject
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EscolaInfoSys.Models.Alert", b =>
                {
                    b.HasOne("EscolaInfoSys.Data.ApplicationUser", "StaffMember")
                        .WithMany()
            ...
            modelBuilder.Entity("EscolaInfoSys.Models.Subject", b =>
                {
                    ...
                    b.HasOne("EscolaInfoSys.Models.FormGroup", null)
                        .WithMany("Subjects")
                        .HasForeignKey("FormGroupId");
